...
SERVER_ROOT_DIR = '/data2/indivo/indivo_ui_server'
INDIVO_SERVER_LOCATION = {'scheme': 'http', 'host': '172.18.113.210', 'port': '8000'}
INDIVO_UI_SERVER_BASE = 'http://134.174.13.85:80'
...
DEBUG = True
TEMPLATE_DEBUG = True
HIDE_GET_MORE_APPS = True
HIDE_HEALTHFEED = True
HIDE_INBOX = False
HIDE_SHARING = True
CONSUMER_KEY='chrome'
CONSUMER_SECRET='chromegp'
ROOT_URLCONF = 'urls'
